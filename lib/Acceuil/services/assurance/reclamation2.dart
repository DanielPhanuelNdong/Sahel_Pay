...
class reclamation2 extends StatefulWidget {
  const reclamation2({super.key});

  @override
  State<reclamation2> createState() => _reclamation2State();
}

class _reclamation2State extends State<reclamation2> {
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: 'Nom complet du proche',
                        ),
                        validator: (value) {
                          if (value!.isEmpty ||
